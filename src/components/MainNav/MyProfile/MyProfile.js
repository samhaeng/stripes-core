...
export default class MyProfile extends Component {
  ...
  getDropdownContent() {
    ...
    /**
     * If show perms is set in stripes config
     */
  ...
  render() {
    return (
      <Dropdown open={this.state.dropdownOpen} id="profileDropdown" onToggle={this.toggleDropdown} pullRight >
        <NavButton data-role="toggle" title="My Profile" selected={this.state.dropdownOpen} icon={this.getProfileImage()} noSelectedBar />
